...
const HumidityDetails: React.FC = () => {
  ...
  const [mainHomeHistoryData, setMainHomeHistoryData] = useState<
    HistoricalData[]
  >([]);
  const [mainHomeHistoryLoading, setMainHomeHistoryLoading] =
    useState<boolean>(true);
  const [mainHomeHistoryError, setMainHomeHistoryError] = useState<
    string | null
  >(null);
  ...
  const [garageHistoryLoading, setGarageHistoryLoading] =
    useState<boolean>(true);
  const [garageHistoryError, setGarageHistoryError] = useState<string | null>(
    null
  );
  ...
  const fetchHistoricalData = async (timeRange: number = selectedTimeRange) => {
    ...
    try {
      const mainHomeData = await apiService.getMainHomeHumidityHistory(
        timeRange
      );
      ...
      <View style={styles.timeRangeSelectorContainer}>
        ...
        <View style={styles.timeRangeSelector}>
          <TouchableOpacity
            style={[
              styles.timeButton,
              selectedTimeRange === 1 && styles.selectedTimeButton,
            ]}
          ...
          >
            <Text
              style={[
                ...
                selectedTimeRange === 1 && styles.selectedTimeButtonText,
              ]}
            >
              1h
            </Text>
          ...
          <TouchableOpacity
            style={[
              styles.timeButton,
              selectedTimeRange === 6 && styles.selectedTimeButton,
            ]}
          ...
          >
            <Text
              style={[
                styles.timeButtonText,
                selectedTimeRange === 6 && styles.selectedTimeButtonText,
              ]}
            >
              6h
            </Text>
          ...
          <TouchableOpacity
            style={[
              styles.timeButton,
              selectedTimeRange === 24 && styles.selectedTimeButton,
            ]}
          ...
          >
            <Text
              style={[
                styles.timeButtonText,
                selectedTimeRange === 24 && styles.selectedTimeButtonText,
              ]}
            >
              24h
            </Text>
          ...
          <TouchableOpacity
            style={[
              styles.timeButton,
              selectedTimeRange === 168 && styles.selectedTimeButton,
            ]}
          ...
          >
            <Text
              style={[
                styles.timeButtonText,
                selectedTimeRange === 168 && styles.selectedTimeButtonText,
              ]}
            >
              7d
            </Text>
                  ...
                  data={{
                    labels: garageHistoryData
                      ...
                      .filter(
                        (_, i, arr) =>
                          i % Math.max(1, Math.floor(arr.length / 6)) === 0
                      ), // Show only 6 labels for readability
                    datasets: [
                      {
